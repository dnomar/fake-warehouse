 ...
 * User and password authentication, this class dont use SSL
 */
public class MysqlConnectionStringWriter implements IDbConnectionStringBuilder{//Class.forName("com.microsoft.sqlserver.jdbc.SQLServerDriver");
	...
	public void takeDatabase(String db){
		connectionString=connectionString+db+"?useSSL=false";
	}
